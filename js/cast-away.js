...
(function() {
  ...
  Session = (function(_super) {
    ...
    Session.prototype.music = function(config, cb) {
      ...
      metadata = new this.cast.media.MusicTrackMediaMetadata();
      metadata.metadataType = this.cast.media.MetadataType.MUSIC_TRACK;
    ...
    Session.prototype.tvShow = function(config, cb) {
      ...
      mediaInfo = new this.cast.media.MediaInfo(config.url, config.contentType);
      metadata = new this.cast.media.TvShowMediaMetadata();
      metadata.metadataType = this.cast.media.MetadataType.TV_SHOW;
      mediaInfo.metadata = assignMetadata(metadata, config);
      return this.load(mediaInfo, cb);
    };
    ...
    Session.prototype.movie = function(config, cb) {
      ...
      mediaInfo = new this.cast.media.MediaInfo(config.url, config.contentType);
      metadata = new this.cast.media.MovieMediaMetadata();
      metadata.metadataType = this.cast.media.MetadataType.MOVIE;
      mediaInfo.metadata = assignMetadata(metadata, config);
      return this.load(mediaInfo, cb);
    };
    ...
    Session.prototype.photo = function(config, cb) {
      ...
      mediaInfo = new this.cast.media.MediaInfo(config.url, config.contentType);
      metadata = new this.cast.media.PhotoMediaMetadata();
      metadata.metadataType = this.cast.media.MetadataType.PHOTO;
      mediaInfo.metadata = assignMetadata(metadata, config);
      return this.load(mediaInfo, cb);
    };
